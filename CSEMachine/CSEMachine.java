...
public class CSEMachine {
    ...
    public void execute() {
        Environment currentEnvironment = this.environment.get(0);
        int j = 1;
...
//	        printEnvironment();
            ...
            // rule no. 5
            } else if (currentSymbol instanceof Environment) {     
...
//            	System.out.println(this.stack.get(0).getData());
                ...
                this.environment.get(((Environment) currentSymbol).getIndex()).setIsRemoved(true);
